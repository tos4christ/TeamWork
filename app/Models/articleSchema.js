...
articleSchema.getAllArticleNoComment = 'select a.employee_id as author, a.article_id as id, a.creation_date as createdOn, a.article_title as title, a.article_text as article FROM articles a WHERE a.employee_id=$1 AND a.article_id NOT IN (SELECT article_id FROM article_comment)';
