...
gifSchema.getGifNoComment = 'select g.gif_id as id, g.creation_date as "createdOn", g.gif_title as title, g.gif_url as url FROM gif_table g WHERE g.employee_id=$1 AND g.gif_id NOT IN (SELECT gif_id FROM gif_comment)';
