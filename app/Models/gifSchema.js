...
gifSchema.getAGif = 'select g.employee_id as authorId, g.gif_id as id, g.creation_date as "createdOn", g.gif_title as title, g.gif_url as url from gif_table g where g.gif_id=$1';
